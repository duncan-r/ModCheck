...
"    QTextEdit { selection-color: black }")
        ...
        CheckFilesDialog.setTabOrder(self.resultsTabWidget, self.missingFilesTable)
    ...
    def retranslateUi(self, CheckFilesDialog):
        ...
        self.resultsTabWidget.setTabText(self.resultsTabWidget.indexOf(self.logTab), _translate("CheckFilesDialog", "Log Check"))
