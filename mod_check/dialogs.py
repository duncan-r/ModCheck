...
class AssessmentDialog(DialogBase, assessment_ui.Ui_AssessmentDialog):
    ...
    def fileCheck(self):
        ...
        tcf_path = "C:/Users/ermev/Documents/Programming/Test_Data/Modcheck/MortonOnLugg_TuflowClassic/tuflow/runs/MoretonOnLugg_~s1~_~e1~_009.tcf"
        ...
        for inp in tcf_inputs:
            if isinstance(inp, FileInput):
                ...
                if 'tmf' in inp.value.lower() and '|' in inp.value:
                    missing = False
                tcf_files.append('({}) {} - {}'.format(missing, scope, value))
            
            elif isinstance(inp, SettingInput):
                scope = inp.scope()
                value = inp.value
                value = inp.update_value
