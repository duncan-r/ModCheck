...
class ModCheck:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ModCheck', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/mod_check/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'ModCheck'),
            callback=self.run,
